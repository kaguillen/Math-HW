...
\begin{proof}
  ...
  \[\begin{bmatrix}
    ...
    2 & 4 & 7 & 2 
  \end{bmatrix}\]
  Next we will label under each matrix the operation we will be performing ($Rn$ represents the $n$th row, where $x\cdot Rn$ is to mean multiply the $n$th row by $x$),
  \begin{align*}
    \putunder{\begin{bmatrix}
      2 & 3 & 5 & 10 \\
      4 & 5 & 8 & 11 \\
      2 & 4 & 7 & 2 
    \end{bmatrix}}{R2 = R2 - 2\cdot R3} &\rightarrow  \putunder{\begin{bmatrix}
      2 & 3 & 5 & 10 \\
      0 & 14 & 11 & 7 \\
      2 & 4 & 7 & 2 
    \end{bmatrix}}{R3 = R3 - R1} \rightarrow \putunder{\begin{bmatrix}
      ...
      0 & 14 & 11 & 7 \\
      0 & 1 & 2 & 9 
    \end{bmatrix}}{R3 = 14\cdot R3 - R2} \rightarrow \putunder{\begin{bmatrix}
      2 & 3 & 5 & 10 \\
      0 & 14 & 11 & 7 \\
      0 & 0 & 0 & 0 
    \end{bmatrix}}{R2 = 4\cdot R2} \\ \rightarrow \putunder{\begin{bmatrix}
      2 & 3 & 5 & 10 \\
      0 & 5 & 10 & 11 \\
      0 & 0 & 0 & 0 
